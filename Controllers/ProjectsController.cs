...
namespace BugTracker.Controllers
{
    ...
    public class ProjectsController : Controller
    {
        ...
        public async Task<IActionResult> AllProjects()
        {
            ...
            {
                //Gets all projects where Archived == false
                projects = await _projectService.GetAllProjectsByCompanyAsync(companyId);
            }
        ...
        public async Task<IActionResult> AssignMembers(ProjectMembersViewModel model)
        {
            if (model.SelectedUsers != null)
            {
                ...
                foreach (string selectedMember in model.SelectedUsers)
                {
                    await _projectService.AddUserToProjectAsync(selectedMember, model.Project.Id);
                }
        ...
        public async Task<IActionResult> Edit(AddProjectWithPMViewModel model)
        {
            ...
            return RedirectToAction(nameof(Edit), new { id = model.Project.Id });
        }
