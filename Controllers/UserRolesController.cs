...
namespace BugTracker.Controllers
{
    ...
    public class UserRolesController : Controller
    {
        ...
        public async Task<IActionResult> ManageUserRoles()
        {
            ...
            // - instantiate ViewModel to hold current user and roles
            // - user _rolesService to get current role and selected roles for the current user
            // - Create multi-selects for the view
